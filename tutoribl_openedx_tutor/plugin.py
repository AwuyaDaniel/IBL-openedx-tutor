...
hooks.Filters.CONFIG_DEFAULTS.add_items(
    [
        ...
        # Prefix your setting names with 'IBL_OPENEDX_TUTOR_'.
        ("IBL_OPENEDX_TUTOR_VERSION", __version__),
    ]
)
...
hooks.Filters.IMAGES_BUILD.add_items(
    [
        ...
        # you would add a Dockerfile to templates/IBL-openedx-tutor/build/myimage,
        # and then write:
        ### (
        ###     "myimage",
        ###     ("plugins", "IBL-openedx-tutor", "build", "myimage"),
        ###     "docker.io/myimage:{{ IBL_OPENEDX_TUTOR_VERSION }}",
        ###     (),
        ### ),
    ]
)
...
hooks.Filters.ENV_TEMPLATE_ROOTS.add_items(
    ...
    [
        pkg_resources.resource_filename("tutoribl_openedx_tutor", "templates"),
    ]
)
...
hooks.Filters.ENV_TEMPLATE_TARGETS.add_items(
    ...
    # For example, ``tutoribl_openedx_tutor/templates/IBL-openedx-tutor/build``
    # will be rendered to ``$(tutor config printroot)/env/plugins/IBL-openedx-tutor/build``.
    [
        ("IBL-openedx-tutor/build", "plugins"),
        ("IBL-openedx-tutor/apps", "plugins"),
    ],
)
